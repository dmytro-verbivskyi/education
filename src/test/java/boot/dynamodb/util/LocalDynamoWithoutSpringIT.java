...
import static boot.dynamodb.util.LocalDynamoDBCreationRule.Client.PLEASE_CREATE;
import static org.assertj.core.api.Assertions.assertThat;
import static org.assertj.core.api.AssertionsForClassTypes.assertThatThrownBy;

@Ignore //todo: need to be fixed!
@RunWith(JUnit4.class)
public class LocalDynamoWithoutSpringIT {

    @ClassRule
    public static final LocalDynamoDBCreationRule dynamoDB = new LocalDynamoDBCreationRule(PLEASE_CREATE);
